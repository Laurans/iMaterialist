...
from new.extractor import ImageTaskFolder
...
def load_data_from_scratch(hyperparams, categorical_prepocess=True):
    ...
    dsets = {x: ImageTaskFolder("{}/{}_raw".format(data_folder, x), "{}/{}.pkl".format(data_folder,x), trans=data_transforms[x], mode=x) for x in
