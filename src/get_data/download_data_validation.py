...
with open('data/raw/fgvc4_iMat.validation.data.json') as data_file:
...
# errors = []
# print(len(data))
# for dict_item in tqdm.tqdm(data, desc='Get validation images'):
#     extension = dict_item['url'][0].split('.')[-1].lower()
...
#
#
# pickle.dump(errors, open('data/logs/errors_download_validation.pkl', 'wb'))
